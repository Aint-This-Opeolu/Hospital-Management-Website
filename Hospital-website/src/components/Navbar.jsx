      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center gap-1">
            ...
            <Link to="/login" className="ml-3 px-4 py-2 rounded-full text-sm font-medium bg-slate-50">Login</Link>
            {user && user.role === 'admin' && <Link to="/admin" className="ml-3 px-4 py-2 rounded-full text-sm font-medium">Admin</Link>}
            {user && user.role === 'doctor' && <Link to="/doctor" className="ml-3 px-4 py-2 rounded-full text-sm font-medium">Doctor</Link>}
            {user && user.role === 'patient' && <Link to="/patient" className="ml-3 px-4 py-2 rounded-full text-sm font-medium">My Appointments</Link>}
          </div>
